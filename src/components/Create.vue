...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            <form v-on:submit.prevent="AddRecord" autocomplete="off" class="form-horizontal">
                <div class="card mx-auto">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">Creando Tarea</h4>
                    </div>
                    <div class="card-body" >
...
export default {
    ...
    methods: {
        async AddRecord() {
            try {
                await axios.post('http://localhost/laravel-crud-api/public/api/tasks',this.task);
